...
const CRY = {
    ...
    YES: (text, cipher, key, code) => SCRY.then(xp => xp['en' + cipher]).then(fn => console.log(fn(1, 2))),
    NO: (text, cipher, key, code) => SCRY.then(xp => xp['de' + cipher]).then(fn => console.log(fn(1, 2)))
};
