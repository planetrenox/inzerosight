...
// function wait()
// {
//     setInterval(initScan, 2000);
// }
//
// function initScan()
// {
//     const key = new RegExp('\u{180E}');
//     if (!key.test(document.getElementsByTagName("body")[0].textContent)) // performance https://stackoverflow.com/revisions/5296314/6
//     {
//         return;
//     }
//
//     let izs1p2 = false;
//     let nodeList = document.querySelectorAll("p, h1, h2, h3, h4, h5, h6");
//     for (let i = nodeList.length - 1; i > 0; i--)
//     {
//         let innerContent = nodeList[i].textContent;
//         let innerRes = key.test(innerContent);
//         if (innerRes)
//         {
//             izs1p2 = true; // temp
//             let stripped = innerContent.replace(/[^\u200B\u200C\u200D\u2060\u00AD\uFEFF\u200E\u180E]/g, "");
...
//         inlineScript.src = browser.runtime.getURL('inline/inlineScript.js');
